-- ============================================================
-- PeerLink - DATABASE RESET + RE-SEED (MySQL / phpMyAdmin)
-- ------------------------------------------------------------
-- 1. Wipes ALL rows from every table
...
--
-- HOW TO USE: Paste this whole file into the phpMyAdmin SQL tab
-- or run via MySQL CLI. Destructive: all existing data is reset.
-- ============================================================

SET FOREIGN_KEY_CHECKS = 0;

TRUNCATE TABLE activity_logs;
TRUNCATE TABLE user_warnings;
TRUNCATE TABLE user_reports;
TRUNCATE TABLE password_reset_tokens;
TRUNCATE TABLE conversation_payments;
TRUNCATE TABLE payments;
TRUNCATE TABLE reschedule_requests;
...
TRUNCATE TABLE subject_requests;
...
-- ------------------------------------------------------------
-- USERS (7 demo accounts — passwords Tutor@123 / Student@123 / Admin@123 / Faculty@123)
-- ------------------------------------------------------------
